    ...
    <div class="project-1 project">
      <a href={project.link} target="_blank" rel="noreferrer">
        <div class="img-container">
          <img src={project.image} class="photo-reflection photo-project" alt="reflection" />
        </div>
        <p class="project-title project-title-1">{project.title}</p> 
      </a>         
      <a href={project.github} target="_blank" class="project-details" rel="noreferrer" >View Project Files
        <i class="fas fa-arrow-circle-right"></i>
      </a>
      
      <button class="btn-project more-info-btn-1">More Info...</button>
      <div class="text-holder">{project.description}</div>   
    </div>
    ))
    }
